...
function rebuildGlobalRawData() {
  ...
  state.rawExcelCache.forEach(os => {
    ...
    if (tk) state.globalRawData.push({ techKey:tk, cidade:state.teamData[tk].base, tipo:state.teamData[tk].tipo||'INSTALAÇÃO CIDADE', day:os.day, monthStr:os.monthStr });
  });
  applyFilters();
}
...
/* ═══════════════════════════════════════════════════════════
   NAMESPACE GLOBAL — window.App (chamado pelo HTML)
   ═══════════════════════════════════════════════════════════ */
window.App = {
  // Nav
  switchTab,
